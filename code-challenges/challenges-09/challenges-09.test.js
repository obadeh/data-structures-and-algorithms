...
const countNumberOfElements = (arr) => {
    // Solution code here...
    let countA= arr.reduce((acc,value,indx)=>{
      acc=acc+1;
      return acc;
    },0)
    return countA;
...
const returnNames = (arr) => {
    // Solution code here...
    let newArr=[];
    let play=arr.reduce((acc,val,indx)=>{
...
const reversedString = (str) => {
    // Solution code here...
   let reversed = str.split('').reduce((first,second)=> second + first, '');
   return reversed;
  };
...
const calculateAverage = (arr) => {
    ...
    let count = 0;
    let sum = arr.reduce((acc,value,indx)=>{
      acc = acc + value ;
      count++;
      return acc;
    },0);
...
const countPrimeNumbers = (arr) => {
    ...
    let prime = arr.reduce((acc,value,indx) => {
      if(isPrime(value)){
        acc++;
      }
      return acc
